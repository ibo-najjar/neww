...
import "./View.scss";
import pic1 from "../assets/404-not-found.png";
  ...
  async function copyTextToClipboard() {
    if ("clipboard" in navigator) {
      ...
      return await navigator.clipboard.writeText(
        `${process.env.REACT_APP_USER_URL}view/${id}`
      );
    } else {
      ...
      <div className="view-container">
        <div className="more-info">
          ...
          <div className="row-info">
            ...
            <h4 id="sub-info">{user.age}</h4>
          </div>
          <div className="row-info">
            <h4 id="header-name">الوزن</h4>
            <h4 id="sub-info">{`${user.weight}` + "kg"}</h4>
          </div>
          <div className="row-info">
            <h4 id="header-name">الطول</h4>
            <h4 id="sub-info">{user.height}cm</h4>
          </div>
          <div className="row-info">
